...
void CollisionHandler::BeginContact(b2Contact *contact) {
    ...
    ColliderEntryEvent entry_event = ColliderEntryEvent {body_a, body_b, contact->IsTouching()};
...
void CollisionHandler::EndContact(b2Contact *contact) {
    ...
    ColliderExitEvent exit_event = ColliderExitEvent {body_a, body_b, contact->IsTouching()};
