...
Camera::Camera(int aspect_width, int aspect_height, bool is_world_space, Transform transform, const Color& background_color, float mtp, float screen_space_limits) :
